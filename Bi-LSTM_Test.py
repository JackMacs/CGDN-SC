...
def main():
    ...
    with tf.name_scope('hidden2'):
        ...
        # hidden2 = tf.multiply(hidden2, word_weight)  # combining the Bi-LSTM with the decision weight matrix
    ...
    with tf.name_scope('loss'):
        ...
        cross_entropy = loss_sum/mask * ww  # ww function: increase the loss value to prevent the gradient from disappearing
