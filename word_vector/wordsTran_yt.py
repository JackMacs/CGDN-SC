...
for string in sentence:
    ...
    for ch in temp:
        str = str+ch+' '
    # prmodel = Word2Vec(train_words, size=128, window=4, min_count=1, sg=1, workers=2)
    # model.save('/Users/fighting/PycharmProjects/BiLSTM_MClassification/fuctions_test/wordVec_model/word2vecModel_yt')
    # print(model['承诺达'])int(str)
    words.append(str)
